...
REPOSITORIES_CONF=
PROG=$0
# inizializza qui anche le variabili-array usate più tardi
repositories_volume=()
...
function run_cmd_in_container {
    ...
    # inizializza sempre l’array (locale) per evitare 'unbound variable'
    local repositories_volume=()
...
DOCKER_RUN="docker run --platform linux/amd64 -e GOSU_UID=$(id -ur) -e GOSU_GID=$(id -g)"
DOCKER_OPTS=()
